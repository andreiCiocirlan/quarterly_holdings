...
ALL_FILERS2_CSV = os.path.join(DATA_SOURCES_DIR, 'all_filers2.csv')
ALL_OWNERSHIP_2024_Q4_CSV = os.path.join(DATA_SOURCES_DIR, 'all_ownership_2024_Q4.csv')
ALL_OWNERSHIP_2025_Q1_CSV = os.path.join(DATA_SOURCES_DIR, 'all_ownership_2025_Q1.csv')
TOP_100_ADDED_TICKERS_CSV = os.path.join(DATA_SOURCES_DIR, "top_100_added.csv")
TOP_100_REDUCED_TICKERS_CSV = os.path.join(DATA_SOURCES_DIR, "top_100_reduced.csv")
OVER_100_OWNERSHIP_TICKERS_CSV = os.path.join(DATA_SOURCES_DIR, "over_100_ownership.csv")
SUBMISSIONS_DIR = os.path.join(DATA_DIR, "submissions")
FILER_ACCESSION_METADATA = os.path.join(DATA_SOURCES_DIR, 'filer_accession_metadata.csv')
...
STOCKS_SHS_Q_END_PRICES_FILE = os.path.join(DATA_SOURCES_DIR, 'stock_shs_q_end_prices.csv')
